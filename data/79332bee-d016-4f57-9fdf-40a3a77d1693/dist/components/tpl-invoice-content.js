...
const InvoiceContentTpl = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
  ...
  static get style() { return _1InvoiceContentCss; }
}, [0, "tpl-invoice-content", {
    "invoice": [32]
  }]);
function defineCustomElement$1() {
  ...
  const components = ["tpl-invoice-content"];
  components.forEach(tagName => { switch (tagName) {
    case "tpl-invoice-content":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, InvoiceContentTpl);
      }
      break;
  } });
}

const TplInvoiceContent = InvoiceContentTpl;
const defineCustomElement = defineCustomElement$1;

export { TplInvoiceContent, defineCustomElement };
